...
module.exports={
  ...
  "words": [
    "a clap with a clang",
    "a fit name with an action open",
    "as claque repose",
    "see leave gloss or a dark place",
    "in the region of the glottic wheat",
    "upon the angle between glide bomb",
    "a glaze motion without pass powers",
    "meat in hue or of low",
    "wanting dull as in smoothness",
    "model slopes globose"
  ],
  "videos": [{
    "filename": "0.mp4",
    "duration": 2.338,
